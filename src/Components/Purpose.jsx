    ...
    <div className="bg-[#75D1D8] py-[3%] px-[3%]">
      ...
      <div className="space-y-4 mt-4 max-[600px]:p-2">
        <p className="text-[16px] font-[400] leading-[1.7rem] text-[#14201B] ">
          ...
          a centralized to streamline the process for suppliers, installers, and
          users.
        </p>
        <p className="text-[16px] font-[400] leading-[1.7rem] text-[#14201B]">
          ...
          contract in transparent way. We ensure win-win situation for all.
