  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="mb-4">
        ...
        products. By using our services, you (User) agree to following Terms and
        Conditions to use marketplace “CUSP”, a brand of Synergy Sustainability
        Solutions Pvt. Ltd. having registered office at B-102, Kalyani
        Apartment, Sector 6, Vasundhra, Ghaziabad -201012, Uttar Pradesh (CUSP).
      </p>
