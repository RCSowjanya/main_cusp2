    ...
    <div>
      ...
      <div className="bg-[#e3d5d5] flex justify-center py-[4%] items-center max-[1000px]:px-[2%]">
        <div className="px-[5%] bg-white shadow-lg max-w-3xl h-full mx-auto py-[2%]">
          <h2 className="ad text-[1.5rem] font-[600] text-[#004A9C] text-center">
            Partner With CUSP
          </h2>
          ...
          <form className="space-y-4" onSubmit={formik.handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="ad mt-1 p-2 text-[1rem] block w-full placeholder-[#757575]  border-[#CECECE] border rounded-md shadow-sm outline-none"
            ...
            <div className="flex gap-4 max-[600px]:flex-col">
              <div className="flex-1">
                <label
                  htmlFor="mobile"
                  className="block text-[14px] ad text-[#004A9C] font-[600]"
                >
                ...
                <div className="relative">
                  <select
                    id="business_role"
                    className="ad p-2 text-[1rem] block w-full cursor-pointer placeholder-[#757575] border-[#CECECE] border rounded-md shadow-sm outline-none appearance-none"
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  <select
                    id="type_of_entity"
                    className="ad p-2 text-[1rem] cursor-pointer block w-full placeholder-[#757575] border-[#CECECE] border rounded-md shadow-sm outline-none appearance-none"
            ...
            <div className="flex gap-4 max-[600px]:flex-col">
              <div className="flex-1">
                <label
                  ...
                  className="block text-[#004A9C] text-[14px] ad font-[600]"
                >
